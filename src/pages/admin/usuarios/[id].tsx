                ...
                <Grid item xs={12} md={8}>
                  <Container maxWidth="md" sx={{ py: 5 }}>
                    ...
                    <Grid container spacing={2}>
                      ...
                      <Grid item xs={12} md={6}>
                        <RHFSelect name="userType" label="Tipo de usuario" defaultValue={'Administrador'} control={control}>
                  ...
                  <Container maxWidth="md" sx={{ py: 5 }}>
                    ...
                    >
                      ...
                      <Button disabled={loading} fullWidth={!largeScreen} type="submit" variant="contained" onClick={onSubmit}>
