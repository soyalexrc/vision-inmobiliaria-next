...
import { Box, Button, Divider, Typography, Container, Grid, TextField, useMediaQuery, FormControlLabel, Switch } from '@mui/material';
                  ...
                  <Container maxWidth="md" sx={{ py: 5 }}>
                    ...
                    <Grid container spacing={2} sx={{ mt: 3 }}>
                      ...
                      <Grid item xs={12}>
                        ...
                        />
                        <Typography variant="caption" fontWeight="bold" sx={{ color: '#FF0000' }}></Typography>
                      </Grid>
                      <Grid item xs={12}>
                        <TextField
                          fullWidth
                      ...
                      <Grid item xs={12} md={6}>
                        ...
                        />
                        <Typography variant="caption" fontWeight="bold" sx={{ color: '#FF0000' }}>
                          {errors?.type_of_service?.message}
                        </Typography>
                      </Grid>
