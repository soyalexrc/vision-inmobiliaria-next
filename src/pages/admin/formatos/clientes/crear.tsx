              ...
              <Container maxWidth="md" sx={{ py: 5 }}>
                ...
                <Grid container spacing={2} sx={{ mt: 3 }}>
                  ...
                  <Grid item xs={12} md={6}>
                    ...
                    />
                    <Typography variant="caption" fontWeight="bold" sx={{ color: '#FF0000' }}>
                      {errors?.lease_fee_status?.message}
                    </Typography>
                  </Grid>
                  <Grid item xs={12} md={6}>
                    <TextField
                    ...
                    />
                    <Typography variant="caption" fontWeight="bold" sx={{ color: '#FF0000' }}>
                      {errors?.owner_payment_status?.message}
                    </Typography>
                  </Grid>
                  <Grid item xs={12} md={6}>
                    <TextField
                    ...
                    />
                    <Typography variant="caption" fontWeight="bold" sx={{ color: '#FF0000' }}>
                      {errors?.status_condo_cleanliness_payment?.message}
                    </Typography>
                  </Grid>
                  ...
                  <Grid item xs={12} md={6}>
                    ...
                    />
                    <Typography variant="caption" fontWeight="bold" sx={{ color: '#FF0000' }}>
                      {errors?.status_electricity_payment?.message}
                    </Typography>
                  </Grid>
                  ...
                  <Grid item xs={12} md={6}>
                    ...
                    />
                    <Typography variant="caption" fontWeight="bold" sx={{ color: '#FF0000' }}>
                      {errors?.date_to_collect_lease_fee?.message}
                    </Typography>
                  </Grid>
                  ...
                  <Grid item xs={12} md={6}>
                    ...
                    />
                    <Typography variant="caption" fontWeight="bold" sx={{ color: '#FF0000' }}>
                      {errors?.next_adjustment?.message}
                    </Typography>
                  </Grid>
                  <Grid item xs={12} md={6}>
                    <TextField
                    ...
                    />
                    <Typography variant="caption" fontWeight="bold" sx={{ color: '#FF0000' }}>
                      {errors?.next_subcription?.message}
                    </Typography>
                  </Grid>
                  <Grid item xs={12}>
                    <TextField
