...
const mainData = [
  {
    url: '',
    alt: '',
    image: '/images/banners/sell-banner.jpg',
  },
];
...
export default function SellPage() {
  ...
  return (
    <ClientLayout title="Vision Inmobiliaria - Venta de inmuebles">
      <>
            ...
            <Grid item container spacing={2} xs={12} md={8}>
              ...
              {viewType !== 'map' &&
                LATEST_ELEMENTS_DATA.map((element: any, index) => (
                  <Grid item key={index + 1} xs={12} sm={viewType === 'grid' ? 6 : 12}>
                    <ProductComponent product={element} view={viewType} />
                  </Grid>
                ))}
              {viewType === 'map' && (
                <Box mt={6} component="img" src="/images/map.png" height="750px" width="100%" sx={{ objectFit: 'cover' }} />
              )}
