...
export default function LongStaysPage() {
  ...
  return (
    <ClientLayout title="Vision Inmobiliaria - Alquiler de inmuebles - Temporadas largas">
      <>
        ...
        <Container>
          <Grid container columnSpacing={5} rowSpacing={2} sx={{ my: 3 }}>
            ...
            <Grid item container spacing={2} xs={12} md={8}>
              ...
              {viewType === 'map' && <Box mt={6} component="img" src="/images/map.png" height="750px" sx={{ objectFit: 'cover' }} />}
