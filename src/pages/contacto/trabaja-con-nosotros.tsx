          ...
          <Grid container columnSpacing={3} sx={{ my: 4 }}>
            <Grid item xs={12} md={6} sx={{ borderRight: largeScreen ? '1px solid lightgray' : 'transparent', px: 3 }}>
              <Typography fontSize="17px">
                <b>Vision Inmobiliaria,</b> ofrece la posibilidad de poner tu inmueble en venta a través de nosotros de una forma fácil,
                sencilla y de forma gratuita. Introduce los datos en el apartado que ves abajo y nos pondremos en contacto contigo lo antes
                posible...
              </Typography>
            ...
            <Grid item xs={12} md={6}>
              ...
              <Box>
                <Box {...getRootProps({ className: 'dropzone' })} p={5} sx={{ border: '2px dashed gray' }} my={3}>
                  ...
                  <Box display="flex" alignItems="center" justifyContent="center">
                    <FilePresentIcon />
                    <Typography align="center" fontWeight="bold" color="gray">
                      Agrega tu cv aqui
                    </Typography>
                  </Box>
                </Box>
              ...
              <Box display="flex" alignItems="center" mt={5}>
                ...
                <Typography>
                  ...
                  >
                    {' '}
                    condiciones legales y de politica de privacidad
                  </Typography>
                </Typography>
              </Box>
