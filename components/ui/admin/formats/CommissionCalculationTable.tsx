        ...
        <Table width="100%">
          ...
          <TableBody>
            {!loading &&
              data &&
              data.length > 0 &&
              data.slice(getCurrentPage(), getCurrentPageLimit()).map((row, index: number) => (
                <TableRow
                  key={row.id}
                  sx={{
                ...
                >
                  ...
                  <TableItem>
                    <Box width={100}>{row.date_application}</Box>
                  </TableItem>
                  <TableItem>
                    <Box width={180}>{row.bill_number}</Box>
                  </TableItem>
                  <TableItem>
                    <Box width={180}>{row.property}</Box>
                  </TableItem>
                  <TableItem>{row.client}</TableItem>
                  <TableItem>
                    <Box width={180}>{row.adviser_in_charge}</Box>
                  </TableItem>
                  <TableItem>
                  ...
                  <TableItem>
                    <Box width={180}>{row.expenses}</Box>
                  </TableItem>
                  <TableItem>
                    <Box width={180}>{row.lawyer_calculation_20}</Box>
                  </TableItem>
                  <TableItem>
                    <Box width={180}>{row.lawyer_calculation_30}</Box>
                  </TableItem>
                  <TableItem>
                    <Box width={180}>{row.lawyer_calculation_40}</Box>
                  </TableItem>
                  <TableItem>
                    <Box width={180}>{row.adviser_calculation_10}</Box>
                  </TableItem>
                  <TableItem>
                    <Box width={180}>{row.company_profit}</Box>
                  </TableItem>
                  <TableItem>
                    <Box width={180}>{row.stationary}</Box>
                  </TableItem>
                  <TableItem>
                    <Box width={180}>{row.total_paid_lawyer}</Box>
                  </TableItem>
                  <TableItem>
                    <Box width={180}>{row.total_due_lawyer}</Box>
                  </TableItem>
                  <TableItem>
                    <Box width={180}>{row.payment_date_lawyer}</Box>
                  </TableItem>
                  <TableItem>
                    <Box width={180}>{row.status_lawyer}</Box>
                  </TableItem>
                  <TableItem>
                    <Box width={180}>{row.total_paid_adviser}</Box>
                  </TableItem>
                  <TableItem>
                    <Box width={400}>{row.total_due_adviser}</Box>
                  </TableItem>
                  <TableItem>
                    <Box width={400}>{row.payment_date_adviser}</Box>
                  </TableItem>
                  <TableItem>
                    <Box width={400}>{row.status_adviser}</Box>
                  </TableItem>
                  <TableItem>
