...
export function ClientsFilterDrawer({ open, closeAction, applyFilters, largeScreen, selectFilter, filters }: PropertiesFiltersDrawerProps) {
  return (
          ...
          <Grid container spacing={2} sx={{ mt: 2 }}>
            ...
            <Grid item xs={12} md={6}>
              ...
              <Autocomplete
                ...
                renderInput={(params) => <TextField {...params} label="Busqueda por corredor" />}
              />
            </Grid>
            ...
            <Grid item xs={12} md={6}>
              ...
              <Autocomplete
                ...
                renderInput={(params) => <TextField {...params} label="Tipo de inmueble" />}
              />
            </Grid>
            <Grid item xs={12} md={6}>
              ...
              <Autocomplete
                ...
                renderInput={(params) => <TextField {...params} label="Tipo de operacion" />}
              />
            </Grid>
            <Grid item xs={12}>
              <Divider sx={{ my: 2 }} />
            ...
            <Grid item xs={12} md={6}>
              ...
              <Autocomplete
                ...
                onChange={(e, newValue) => selectFilter('', newValue)}
                renderInput={(params) => <TextField {...params} label="Urbanizacion" />}
              />
            </Grid>
            ...
            <Grid item xs={12} md={6}>
              ...
              <Autocomplete
                ...
                onChange={(e, newValue) => selectFilter('', newValue)}
                renderInput={(params) => <TextField {...params} label="Residencia" />}
              />
            </Grid>
          </Grid>
        </Box>
