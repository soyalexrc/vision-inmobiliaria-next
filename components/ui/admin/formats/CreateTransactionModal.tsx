...
import {
    ...
    IconButton,
    useMediaQuery,
    Typography, Grid, Container, TextField
} from '@mui/material';
...
export function CreateTransactionModal({close, open}: any) {
    ...
    const {register, handleSubmit, control, formState: {errors}, setValue} = useForm<Transaction>({
                    ...
                    <Grid container spacing={2}>
                        <Grid item xs={12} >
                            <Container maxWidth='md' >
                                <Typography variant='h5' align='center' color='secondary.light'>Datos de traslado</Typography>
                                <Grid container spacing={2} sx={{mt: 3}}>
                                    <Grid item xs={12} md={5}>
                                        <RHFAutocomplete
                                            ...
                                            label='Entidad'
                                        />
                                        <Typography variant='caption' fontWeight='bold' sx={{color: '#FF0000'}}>{errors?.originEntity?.message}</Typography>
                                    </Grid>
                                    {
                                        largeScreen &&
                                    ...
                                    <Grid item xs={12} md={5}>
                                        <RHFAutocomplete
                                            ...
                                            label='Entidad'
                                        />
                                        <Typography variant='caption' fontWeight='bold' sx={{color: '#FF0000'}}>{errors?.destinyEntity?.message}</Typography>
                                    </Grid>
                                    <Grid item xs={12} md={4}>
                                        <TextField
                                            ...
                                            variant="outlined"
                                        />
                                        <Typography variant='caption' fontWeight='bold' sx={{color: '#FF0000'}}>{errors?.amount?.message}</Typography>
                                    </Grid>
                                    ...
                                    <Grid item xs={12} md={4}>
                                        <RHFAutocomplete
                                            ...
                                            size='small'
                                        />
                                        <Typography variant='caption' fontWeight='bold' sx={{color: '#FF0000'}}>{errors?.way_to_pay?.message}</Typography>
                                    </Grid>
                                    <Grid item xs={12} md={4}>
                                        <RHFAutocomplete
                                            name="currency"
                                            ...
                                            label='Moneda'
                                        />
                                        <Typography variant='caption' fontWeight='bold' sx={{color: '#FF0000'}}>{errors?.currency   ?.message}</Typography>
                                    </Grid>
                                    <Grid item xs={12} >
                                        ...
                                        />
                                        <Typography variant='caption' fontWeight='bold' sx={{color: '#FF0000'}}>{errors?.reason?.message}</Typography>
                                    </Grid>
