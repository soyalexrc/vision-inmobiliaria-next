          ...
          <TableBody>
            {!loading &&
              ...
              data.slice(getCurrentPage(), getCurrentPageLimit()).map((row, index: number) => (
                ...
                >
                  <TableCell>
                    <Box width={80}>{row.date}</Box>
                  </TableCell>

                  <TableCell>
                    <Box width={200}>
                      {row.property && row.property.id
                        ? `${row.property.code} - ${row.property.property_type} - ${row.property.operation_type}`
                        : 'not set'}
                    </Box>
                  </TableCell>
