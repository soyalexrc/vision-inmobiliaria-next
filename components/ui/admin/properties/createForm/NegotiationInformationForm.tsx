...
export function NegotiationInformationForm() {
  ...
  async function getData() {
    try {
      setLoading(true);
      Promise.all([getOwners(), getAllies(), getAdvisers()]).then((values) => {
        setOwners(values[0]);
        setAllies(values[1]);
  ...
  return (
    <Grid container spacing={4}>
      <Grid item xs={12} md={3}>
        ...
        <TextField color="secondary" fullWidth placeholder="Precio" {...register('property.price')} variant="outlined" />
      </Grid>
      <Grid item xs={12} md={3}>
        <RHFSelect
      ...
      <Grid item xs={12} md={3}>
        ...
        <TextField color="secondary" disabled fullWidth placeholder="Nombres" {...register('clientData.firstName')} variant="outlined" />
      </Grid>
      <Grid item xs={12} md={3}>
        <Typography fontWeight="bold" sx={{ mb: 1 }}>
          Apellidos
        </Typography>
        <TextField color="secondary" disabled fullWidth placeholder="Apellidos" {...register('clientData.lastName')} variant="outlined" />
      </Grid>
      <Grid item xs={12} md={3}>
        <Typography fontWeight="bold" sx={{ mb: 1 }}>
          Telefono
        </Typography>
        <TextField color="secondary" disabled fullWidth {...register('clientData.cellPhone')} variant="outlined" />
      </Grid>
      <Grid item xs={12} md={3}>
        <Typography fontWeight="bold" sx={{ mb: 1 }}>
          Email
        </Typography>
        <TextField color="secondary" disabled fullWidth placeholder="Email" {...register('clientData.email')} variant="outlined" />
      </Grid>
      <Grid item xs={12} md={3}>
        <Typography fontWeight="bold" sx={{ mb: 1 }}>
          Fecha de cumpleanos
      ...
      <Grid item xs={12} md={3}>
        ...
        <TextField color="secondary" fullWidth placeholder="Nombres" {...register('clientData.contactFirstName')} variant="outlined" />
      </Grid>
      <Grid item xs={12} md={3}>
        <Typography fontWeight="bold" sx={{ mb: 1 }}>
          Apellidos
        </Typography>
        <TextField color="secondary" fullWidth placeholder="Apellidos" {...register('clientData.contactLastName')} variant="outlined" />
      </Grid>
      <Grid item xs={12} md={3}>
        <Typography fontWeight="bold" sx={{ mb: 1 }}>
          Telefono
        </Typography>
        <TextField color="secondary" fullWidth {...register('clientData.contactCellPhone')} variant="outlined" />
      </Grid>
      <Grid item xs={12} md={3}>
        <Typography fontWeight="bold" sx={{ mb: 1 }}>
          Email
        </Typography>
        <TextField color="secondary" fullWidth placeholder="Email" {...register('clientData.contactEmail')} variant="outlined" />
      </Grid>
      <Grid item xs={12}>
        <Divider sx={{ my: 3 }} />
      </Grid>
      ...
      <Grid item xs={12} md={3}>
        ...
        <TextField color="secondary" fullWidth placeholder="Nombres" {...register('clientData.attorneyFirstName')} variant="outlined" />
      </Grid>
      <Grid item xs={12} md={3}>
        <Typography fontWeight="bold" sx={{ mb: 1 }}>
          Apellidos
        </Typography>
        <TextField color="secondary" fullWidth placeholder="Apellidos" {...register('clientData.attorneyLastName')} variant="outlined" />
      </Grid>
      <Grid item xs={12} md={3}>
        <Typography fontWeight="bold" sx={{ mb: 1 }}>
          Telefono
        </Typography>
        <TextField color="secondary" fullWidth {...register('clientData.attorneyCellPhone')} variant="outlined" />
      </Grid>
      <Grid item xs={12} md={3}>
        <Typography fontWeight="bold" sx={{ mb: 1 }}>
          Email
        </Typography>
        <TextField color="secondary" fullWidth placeholder="Email" {...register('clientData.attorneyEmail')} variant="outlined" />
      </Grid>
    </Grid>
  );
}
