        ...
        <Grid container sx={{ mb: 2 }}>
          ...
          <Grid item xs={12} md={6} sx={{display: 'flex', justifyContent: 'flex-end'}}>
            <Button fullWidth={!largeScreen} variant='contained' color='primary'
                    sx={{display: 'flex', mt: !largeScreen ? 2 : 0}} onClick={() => handleAttributesPanel('create')}>
              <AddIcon/>
              Atributo
            </Button>
          </Grid>
        ...
        <Table>
          <TableHead sx={{backgroundColor: '#eaeaea'}}>
            <TableRow>
              ...
              <TableCell align='center' sx={{color: (theme: any) => theme.palette.common.black, fontWeight: 'bold',}}>Acciones</TableCell>
            </TableRow>
          </TableHead>
          <TableBody>
              ...
              >
                ...
                <TableCell align='center'>
                  <Box display='flex'>
                    ...
                    <DeleteButton title="Se eliminara el siguiente atributo" element={`Atributo: ${row.label}`} onClick={() => deleteAttribute(row.id)}/>
                  </Box>
                </TableCell>
              </TableRow>
            ))}
