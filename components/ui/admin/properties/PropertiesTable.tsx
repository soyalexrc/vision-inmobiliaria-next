  ...
  return (
    <>
        ...
        <Table width="100%">
          ...
          <TableBody>
            {!loading &&
              ...
              properties.data.slice(getCurrentPage(), getCurrentPageLimit()).map((row: any, index: number) => (
                <TableRow
                  key={row.id}
                  sx={{
                ...
                >
                  ...
                  <TableItem>
                    <Typography sx={{ width: 200 }}>
                      {owners && owners.length > 0 && `${owners[0].first_name} ${owners[0].last_name}`}
                    </Typography>
                  </TableItem>
                  <TableItem>
                  ...
                  <TableItem align="center">
                    <Box>
                      ...
                      <Button variant="text" fullWidth size="small" onClick={() => handleOpenHistoryModal(row.id)}>
                        Ver historial
                      </Button>
                    </Box>
                  </TableItem>
      ...
      <ChangeStatusModal
        ...
        data={statusInfo}
        trigger={handleOpenCommissionModal}
        reload={() => reload()}
      />
