...
export function Footer() {
  ...
  return (
    <footer>
      <Box sx={{ backgroundColor: 'primary.light' }} p={1}></Box>
      <Container sx={{ p: 2 }}>
        <Grid container columnSpacing={10}>
          <Grid item xs={12} md={6}>
            ...
            <br />
            <Typography variant="caption">
              Actualmente gestionamos el patrimonio inmobiliario de particulares, entidades financieras y fondos de inversión, ya sea
          ...
          <Grid item xs={12} md={3}>
            <Typography variant="h6" fontWeight="bold" sx={{ ...(!largeScreen && { mt: 3 }) }}>
              Menu
            </Typography>
            {MENU_ITEMS.map((element: any) => (
              <Box key={element.path} my={2}>
                <NextLink href={element.path}>{element.label}</NextLink>
              </Box>
            ))}
          </Grid>
          <Grid item xs={12} md={3}>
            <Typography variant="h6" fontWeight="bold" sx={{ mb: 2, ...(!largeScreen && { mt: 3 }) }}>
              Contáctanos
            </Typography>
      ...
      <Box sx={{ backgroundColor: 'primary.light' }}>
        <Container>
          <Box display="flex" alignItems="center" p={1}>
            <Typography color="primary" component={NextLink} href="/legal/aviso-legal">
              {' '}
              Aviso Legal
            </Typography>
            <Divider sx={{ mx: 2, borderWidth: '1px' }} orientation="vertical" flexItem />
            <Typography color="primary" component={NextLink} href="/legal/proteccion-de-datos">
              Protección de datos
            </Typography>
            <Divider sx={{ mx: 2, borderWidth: '1px' }} orientation="vertical" flexItem />
            <Typography color="primary" component={NextLink} href="/legal/cookies">
              Cookies
            </Typography>
            <Divider sx={{ mx: 2, borderWidth: '1px' }} orientation="vertical" flexItem />
            <Typography color="primary" component={Link} href="https://google.com" target="_blank">
              Creado por LSM Sinergy
            </Typography>
            <Divider sx={{ mx: 2, borderWidth: '1px' }} orientation="vertical" flexItem />
            <Typography color="primary" component={NextLink} href="/admin">
              {' '}
              Ingresar
            </Typography>
          </Box>
