...
export function OurServices() {
  return (
    ...
    >
      ...
      <Box>
        <Typography sx={{ mt: 5 }} letterSpacing={3} align="center" variant="h4" color="#ffff">
          Porque no somos otra inmobiliaria mas, somos integrales.
        </Typography>
        <Typography sx={{ mb: 5 }} variant="h2" align="center" color="#ffff">
          Nuestros servicios
        </Typography>
        <Container sx={{ mt: 8 }}>
          <Grid container spacing={2} justifyContent="center">
            {SERVICES_DATA.map((element) => (
              <Grid item xs={12} md={3} key={element.title}>
                ...
                <Typography sx={{ mb: 4, mt: 2 }} align="center" variant="h4" color="#ffff">
                  {element.title}
                </Typography>
              </Grid>
            ))}
